...
export const FixedAuroraBackground = ({
    ...
    return (
        ...
        >
            ...
            filter blur-[10px] sm:blur-[10px] blur-[6px] invert dark:invert-0
            
            /* Animation disabled on mobile to prevent scroll lag */
            after:content-[""] after:absolute after:inset-0 after:[background-image:var(--white-gradient),var(--aurora)] 
            after:dark:[background-image:var(--dark-gradient),var(--aurora)]
            after:[background-size:200%,_100%] 
            after:hidden md:after:block /* Only show/animate on desktop */
            after:animate-aurora
            after:[background-attachment:fixed] after:mix-blend-difference
            
            pointer-events-none
            absolute -inset-[10px] opacity-20 md:opacity-50 will-change-transform`,
                    showRadialGradient &&
